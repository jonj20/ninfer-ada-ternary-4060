...
release_tag='0.5.0-rtx3090'
repo_root="$(cd -- "$(dirname -- "${BASH_SOURCE[0]}")/.." && pwd)"
build_root="$repo_root/build-sm86-qwen38"
...
checksum_path="$dist_root/SHA256SUMS-v0.5.0.txt"
...
if [[ -f "$repo_root/RELEASE_NOTES_0.5.0.md" ]]; then
  cp -- "$repo_root/RELEASE_NOTES_0.5.0.md" "$product_root/"
fi
